...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$AuthModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/AuthModal.tsx [app-ssr] (ecmascript)"); // 追加
;
'use client';
;
;
...
function Home() {
    ...
    const [isAuthModalOpen, setIsAuthModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // Auth用
    const [formReason, setFormReason] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('暗くて怖い');
    ...
    const signInAnonymously = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInAnonymously();
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('hazard_posts').insert([
            {
                ...
                reason: formReason,
                time_slot: formTime,
                // user_idは SupabaseのRLSで auth.uid() が自動参照されるため
                // クライアントから送らなくてもOKですが、明示的に送ることも可能です。
                // 今回はRLSポリシーで insert with check (auth.uid() = user_id) としたので
                // 明示的に送ります。
                user_id: user.id
            }
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2a4b5c07._.js.map