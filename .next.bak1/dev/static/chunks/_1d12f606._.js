...
// src/components/ClientMapPage.tsx (新規作成)
__turbopack_context__.s([
    "default",
    ()=>ClientMapPage
]);
...
// 距離計算などのヘルパー関数は既存のpage.tsxから移動、または共通化してimportしても良いですが、
// ここでは簡略化のためそのまま記述すると仮定します。
// (以下、calculateDistance, getAddressFromCoords, MapControllerLogic 等の関数定義が必要)
// ※ 既存の page.tsx にある関数定義をすべてここに移動してください。
// --- ここから既存の関数定義 (page.tsxからコピー) ---
...
function MapControllerLogic({ setCenter, setZoom }) {
    ...
    // ※ LPの場合はローカルストレージからの復帰よりも、LPのデフォルト位置を優先したい場合がありますが、
    // ここでは「URLパラメータがあれば従う、なければストレージ」という既存ロジックのままにします。
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MapControllerLogic.useEffect": ()=>{
...
function ClientMapPage({ cityData }) {
    _s1();
    // 初期値の決定：cityDataがあればそれを優先
    ...
    // ... (useEffect, fetchPosts, handler関数群は既存page.tsxの内容をそのままコピー) ...
    // ※ ここでは長くなるため省略しますが、すべてのロジックを含めてください。
    // ※ uploadImage, handleCheckDuplicate, submitNewPost, handleAgreeToExisting などすべて必要です。
    // useEffect(() => { fetchPosts... }, []); など
    // -----------------------------------------------------------
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HazardMap, {
                        ...
                        // onPostUpdate={handlePostUpdate} // handlePostUpdateを定義して渡す
...
_s1(ClientMapPage, "UGhixs40xIJrlw3HPJ2+bouk6rY=", false, function() {
    return [
...
//# sourceMappingURL=_1d12f606._.js.map