...
_c3 = CityBoundary;
function HazardMap({ posts, centerPos, zoomLevel, onMapChange, selectedCityId, mapMode = 'standard', currentUserId, isAdmin = false, onPostUpdate, showHeatmap = false, heatmapRadius = 50, onAdminSelectPost, activePostId// 追加
 }) {
    _s3();
    const currentMode = mapMode && MAP_STYLES[mapMode] ? mapMode : 'standard';
    const tileStyle = MAP_STYLES[currentMode];
    // マーカーのRefを保持するためのオブジェクト
    ...
    // activePostIdが変わったら、そのマーカーのポップアップを開く
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HazardMap.useEffect": ()=>{
