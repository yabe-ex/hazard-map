...
"[project]/src/components/ClientMapPage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ClientMapPage({ cityData, recentPosts = [] }) {
    ...
    // cityDataがある場合はその座標を初期値にし、なければデフォルト値
    const [center, setCenter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(cityData ? {
        lat: cityData.lat,
        lng: cityData.lng
    } : {
        lat: 35.9251,
    ...
    const [zoom, setZoom] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(cityData ? cityData.zoom : 14);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientMapPage.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession().then({
                "ClientMapPage.useEffect": ({ data: { session } })=>{
            ...
            const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "ClientMapPage.useEffect": (_event, session)=>{
                    setUser(session?.user ?? null);
                }
            }["ClientMapPage.useEffect"]);
            return ({
                "ClientMapPage.useEffect": ()=>subscription.unsubscribe()
            })["ClientMapPage.useEffect"];
        }
    }["ClientMapPage.useEffect"], []);
    ...
    const handleListClick = (post)=>{
        console.log('★ Clicked Post Data:', post); // この行を追加
        console.log('lat type:', typeof post.lat, 'lng type:', typeof post.lng); // 型も確認
        // 数値変換を試みる（文字列で来ている可能性も考慮）
        const lat = parseFloat(post.lat);
        const lng = parseFloat(post.lng);
        if (isNaN(lat) || isNaN(lng)) {
            console.error('❌ Invalid coordinates:', post.lat, post.lng);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('この投稿には位置情報がありません');
            return;
        }
        setCenter({
            lat: post.lat,
        ...
        setZoom(16); // ズームイン
        setActivePostId(post.id); // ポップアップを開くトリガー
    };
    const sectionStyle = {
        marginBottom: '28px'
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                className: "jsx-b190e31c5c6bb14a",
                children: [
                    cityData && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            position: 'absolute',
                            top: '10px',
                            left: '50%',
                    ...
                    cityData && recentPosts.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                ...
                                children: recentPosts.map((post)=>{
                                    const displayAddress = post.address ? post.address.replace(/^.*?市/, '') : 'エリア不明';
...
_s1(ClientMapPage, "86amxD14Kx+XV9vIdy2XVrWlSi0=", false, function() {
    return [
...
__turbopack_context__.k.register(_c2, "ClientMapPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_f1985afa._.js.map